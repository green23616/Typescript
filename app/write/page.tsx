      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex ml-64 mt-64 relative">
          ...
          <form method="post" onSubmit={submitEvent}>
            <input type="text" name="name" defaultValue={session?.user?.email ?? ''} placeholder="이름을 입력해주세요" onChange={changeEvent} className="shadow text-gray-700 text-sm mb-2 border w-1/2 outline-none"/>
